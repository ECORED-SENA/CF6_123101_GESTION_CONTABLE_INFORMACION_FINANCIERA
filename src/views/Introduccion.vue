    ...
    .row.mb-5.m-0
      .col-xl-auto
        figure(data-aos="fade-right").d-none.d-xl-block
          img(src="@/assets/curso/intro/img1.png", alt="imagen decorativa" style="max-width: 500px").m-auto
      .col-xl
        .row.align-items-center.caja-text-intro
          .col-xl-2
            figure(data-aos="fade-up").d-none.d-xl-block
              img(src="@/assets/curso/intro/img2.svg", alt="imagen decorativa" style="max-width: 95px").m-auto
          .col-xl-10
    ...
    .row.m-0.align-items-center.caja-text-intro-2
      .col-xl
        .row.align-items-center
          .col-xl-3.m-0
            figure(data-aos="fade-right").d-none.d-xl-block              
              img(src="@/assets/curso/intro/img3.svg", alt="imagen decorativa" style="max-width: 95px").m-auto
          .col-xl-9
      ...
      .col-xl-auto.ajuste-img-intro
        figure(data-aos="fade-left").d-none.d-xl-block
          img(src="@/assets/curso/intro/img4.png", alt="imagen decorativa" style="max-width: 500px").m-auto
